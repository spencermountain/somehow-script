...
// CodeMirror, copyright (c) by Marijn Haverbeke and others
// Distributed under an MIT license: https://codemirror.net/LICENSE
var simpleMode = function simpleMode(CodeMirror) {
  'use strict';
...
var somehowScript = _dereq_('./src');

var CodeMirror = _dereq_('./assets/codemirror');

console.log(CodeMirror);

_dereq_('./assets/simpleMode')(CodeMirror);

_dereq_('./assets/somehowscript')(CodeMirror); // require('./assets/toml')(CodeMirror)
...
},{"./assets/codemirror":1,"./assets/simpleMode":2,"./assets/somehowscript":3,"./src":5}],5:[function(_dereq_,module,exports){
"use strict";
